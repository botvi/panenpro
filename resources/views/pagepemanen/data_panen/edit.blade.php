                        ...
                        <div class="card-body">
                            <form action="{{ route('datapanen.update', $datapanen->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_tph" id="no_tph" class="form-control" required value="{{ old('no_tph', $datapanen->no_tph) }}">       
                                </div>
                                <div class="form-row d-flex flex-wrap justify-content-between">
                                    <div class="form-group flex-fill me-2 mb-3">
                                        ...
                                        <input type="number" name="ripe" id="ripe" class="form-control" required value="{{ old('ripe', $datapanen->ripe) }}">
                                    </div>
                                    <div class="form-group flex-fill me-2 mb-3">
                                        <label class="form-label">Over Ripe</label>
                                        <input type="number" name="over_ripe" id="over_ripe" class="form-control" required value="{{ old('over_ripe', $datapanen->over_ripe) }}">
                                    </div>
                                    <div class="form-group flex-fill me-2 mb-3">
                                        <label class="form-label">Under Ripe</label>
                                        <input type="number" name="under_ripe" id="under_ripe" class="form-control" required value="{{ old('under_ripe', $datapanen->under_ripe) }}">
                                    </div>
                                    <div class="form-group flex-fill me-2 mb-3">
                                        <label class="form-label">EB</label>
                                        <input type="number" name="eb" id="eb" class="form-control" required value="{{ old('eb', $datapanen->eb) }}">
                                    </div>
                                    <div class="form-group flex-fill mb-3">
                                        <label class="form-label">Brondolan</label>
                                        <input type="number" name="brondolan" id="brondolan" class="form-control" required value="{{ old('brondolan', $datapanen->brondolan) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Jumlah Buah Per Blok</label>
                                    <input type="number" name="jumlah_buah_per_blok" id="jumlah_buah_per_blok" class="form-control" required readonly value="{{ old('jumlah_buah_per_blok', $datapanen->jumlah_buah_per_blok) }}">
                                </div>
                                <div class="form-group">
