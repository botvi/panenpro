                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div class="avtar avtar-s bg-light-primary">
                                        <i class="ti ti-clipboard-data f-20"></i>
                                    </div>
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0 text-muted">Total Data Panen</h6>
                                    <h4 class="mb-0">{{ number_format($totalDataPanen) }}</h4>
                                    <p class="mb-0 text-muted text-sm">Record panen dibuat</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div class="avtar avtar-s bg-light-success">
                                        <i class="ti ti-plant-2 f-20"></i>
                                    </div>
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0 text-muted">Total Buah</h6>
                                    <h4 class="mb-0">{{ number_format($totalBuah) }}</h4>
                                    <p class="mb-0 text-muted text-sm">Buah terpanen</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0 text-muted">Buah Ripe</h6>
                                    <h4 class="mb-0">{{ number_format($totalRipe) }}</h4>
                                    <p class="mb-0 text-muted text-sm">Kualitas terbaik</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0 text-muted">Brondolan</h6>
                                    <h4 class="mb-0">{{ number_format($totalBrondolan) }}</h4>
                                    <p class="mb-0 text-muted text-sm">Brondolan terkumpul</p>
                                </div>
                            </div>
                        </div>
                    </div>
