                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Form Tambah Data Rekap Pengiriman</li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Form Tambah Data Rekap Pengiriman</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>Form Tambah Data Rekap Pengiriman</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('data-rekap-pengiriman.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode_panen" id="kode_panen" class="form-control" required>
                                </div>
                                <div class="form-row d-flex flex-wrap justify-content-between">
                                    ...
                                    <div class="form-group flex-fill me-2 mb-3">
                                        ...
                                        <input type="number" name="over" id="over" class="form-control" required>
                                    </div>
                                    <div class="form-group flex-fill me-2 mb-3">
                                        <label class="form-label">UR</label>
                                        <input type="number" name="ur" id="ur" class="form-control" required>
                                    </div>
                                    <div class="form-group flex-fill me-2 mb-3">
                                        <label class="form-label">UDR</label>
                                        <input type="number" name="udr" id="udr" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="brd" id="brd" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">BS</label>
                                    <input type="number" name="bs" id="bs" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">BJr</label>
                                    <input type="text" name="bjr" id="bjr" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">SPH</label>
                                    <input type="number" name="sph" id="sph" class="form-control" required readonly>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">AKP Actual (%)</label>
                                    <input type="number" name="akp_actual" id="akp_actual" class="form-control" readonly required>
                                </div>
