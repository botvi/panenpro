                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('absensipemanen.create') }}" class="btn btn-sm btn-primary">Tambah Data
                                Absensi Pemanen</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($absensipemanen as $m => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('absensipemanen.edit', $item->id) }}"
                                                        class="btn btn-sm btn-warning">Edit</a>
                                                    <form action="{{ route('absensipemanen.destroy', $item->id) }}"
