                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Form Tambah Data Grafik Kepatuhan</li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Form Tambah Data Grafik Kepatuhan</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>Form Tambah Data Grafik Kepatuhan</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('grafikkepatuhan.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="keluar_buah" id="keluar_buah" class="form-control" required>
                                        ...
                                        <option value="Kurang dari 9">Kurang dari 9</option>
                                        <option value="Lebih dari 9">Lebih dari 9</option>
                                    </select>
