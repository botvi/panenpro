                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Dashboard Mandor</h2>
                            </div>
                            <ul class="breadcrumb">
                    ...
                    <div class="col-md-12">
                        <div class="card bg-primary text-white mb-4">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h4 class="text-white mb-2">Selamat datang, {{ $mandor->nama ?? $mandor->username }}!</h4>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card stat-card hover-card">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h4 class="f-w-400 mb-0 animate-counter">{{ number_format($todayHarvest) }}</h4>
                                    <span class="d-block text-uppercase text-muted f-10 f-w-400 mt-1">
                                        Panen Hari Ini
                                    </span>
                                </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card stat-card hover-card">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h4 class="f-w-400 mb-0 animate-counter">{{ number_format($thisWeekHarvest) }}</h4>
                                    <span class="d-block text-uppercase text-muted f-10 f-w-400 mt-1">
                                        Panen Minggu Ini
                                    </span>
                                </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card stat-card hover-card">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h4 class="f-w-400 mb-0 animate-counter">{{ number_format($attendanceRate, 1) }}%</h4>
                                    <span class="d-block text-uppercase text-muted f-10 f-w-400 mt-1">
                                        Tingkat Kehadiran
                                    </span>
                                </div>
                                <div class="col-4 text-end">
                                    <div class="avtar avtar-s bg-light-info">
                                        <i class="ti ti-chart-line f-18"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6 col-xl-3">
                                    <a href="{{ route('datapemanen.create') }}" class="btn btn-light-primary w-100 py-3 hover-effect">
                                ...
                                <div class="col-md-6 col-xl-3">
                                    <a href="{{ route('planakp.create') }}" class="btn btn-light-success w-100 py-3 hover-effect">
                                ...
                                <div class="col-md-6 col-xl-3">
                                    <a href="{{ route('absensipemanen.create') }}" class="btn btn-light-warning w-100 py-3 hover-effect">
                                ...
                                <div class="col-md-6 col-xl-3">
                                    <a href="{{ route('grafikkepatuhan.create') }}" class="btn btn-light-info w-100 py-3 hover-effect">
                    ...
                    new Chart(akpCtx, {
                        ...
                        data: {
                            datasets: [{
                                ...
                                backgroundColor: [
                                    @if($achievementPercent >= 100) '#28a745'
                                    @elseif($achievementPercent >= 80) '#ffc107'
                                    @else '#dc3545'
                                    @endif,
                                    '#e9ecef'
                                ],
