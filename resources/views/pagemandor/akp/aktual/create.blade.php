                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Form Tambah Data Aktual AKP</li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Form Tambah Data Aktual AKP</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>Form Tambah Data Aktual AKP</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('aktualakp.store') }}" method="POST">
                                @csrf
